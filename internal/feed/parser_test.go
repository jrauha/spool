...
<rss version="2.0"><channel>
  ...
  <item><guid>one</guid><title>First</title><link>https://example.com/one</link>
	...
	if parsed.Title != "Example" || parsed.SiteURL != "https://example.com" {
...
<feed xmlns="http://www.w3.org/2005/Atom">
  <title>Example</title><subtitle>News</subtitle><link rel="alternate" href="https://example.com"/>
  <entry><id>one</id><title>First</title><link href="https://example.com/one"/>
	...
	if parsed.Title != "Example" || parsed.Description != "News" || parsed.SiteURL != "https://example.com" {
		t.Fatalf("feed = %#v", parsed)
	}
	if len(parsed.Items) != 1 {
		t.Fatalf("items = %d, want 1", len(parsed.Items))
